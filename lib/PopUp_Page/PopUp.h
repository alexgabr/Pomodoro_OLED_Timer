...
class PopUp: public Page {
    ...
    public:
        ...
        void draw(const uint8_t *title_font, const uint8_t *content_font, void (*content)(uint8_t, uint8_t&), bool title_is_centered = false);
        ...
        void draw(const uint8_t *title_font, const uint8_t *content_font, void (*content)(const char*, uint8_t, uint8_t&), bool title_is_centered = false);
